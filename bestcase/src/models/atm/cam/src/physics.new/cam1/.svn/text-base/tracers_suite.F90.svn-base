...
! Public module data
  ...
  integer, public, parameter :: adv=14        ! number of advected species
  integer, public, parameter :: nadv=5        ! nonadvected ex. haze
  real(r8), allocatable, public :: trtend(:,:,:,:)
...
! -----------------------------Arguments---------------------------------
  ...
  if ( n > trac_ncnst ) then
     ...
     call get_tracer_char(n,name,type_adv,0.0,0.0,'')
...
! ----------------------------- Local ---------------------------------
  ...
  real(r8), dimension(trac_ncnst), parameter :: & !constituent mol. weights
	trac_mw = (/ 16.,2.,26.,28.,30.,40.,40.,42.,44.,50.,54., &
	29.,51.,53. , &
...
subroutine tend_tr(m, lchnk, ncol, q, deltat, snk)
!----------------------------------------------------------------------- 
!
...
subroutine flux_tr(m,ncol, lchnk, tflux, cflux )
!----------------------------------------------------------------------- 
!
...
!--------------------------Arguments-------------------------------------
   ...
   real(r8), intent(out) :: cflux(pcols)    ! surface flux in kg/m^2/s
   real(r8), intent(out) :: tflux(pcols)    ! top boundary flux in kg/m^2/s
   real(r8), dimension(trac_ncnst), parameter :: & !surface flux
	surf_fl = (/ 1.9e-12_r8,0_r8,0_r8,0_r8,0_r8,0_r8, &
	0_r8,0_r8,0_r8,0_r8,0_r8,0_r8,0_r8,0_r8,0_r8,0_r8,0_r8,0_r8 /)
   real(r8), dimension(trac_ncnst), parameter :: & !top boundary flux
	top_fl = (/ -2.66e-12_r8,1.3e-13_r8,3.2e-13_r8,1.4e-14_r8, &
	3.1e-13_r8,2.0e-14_r8,1.4e-15_r8,2.8e-16_r8,3.0e-15_r8,3.4e-14_r8, &
        9.0e-18_r8,1.6e-13_r8,6.3e-15_r8,0_r8,8.6e-14_r8,0_r8,0_r8,0_r8 /)
!--------------------------Local Variables------------------------------

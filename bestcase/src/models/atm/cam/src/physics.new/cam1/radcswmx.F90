...
!
   ...
   real(r8) :: ammr(pcols,pver,Na) ! dust mass mixing ratio        ! FAO
! 
...
!  FAO
   ...
   real(r8) abund_a(pcols,0:pver,Na)         ! Layer absorber amount
   real(r8) tau_sum
   real(r8) tau_w_sum
   real(r8) tau_w_g_sum
   real(r8) tau_w_f_sum
...
! 
   ...
   aertau(1:ncol,1:Nf,1:Na) = 0.0_r8
   aerssa(1:ncol,1:Nf,1:Na) = 0.0_r8
   aerasm(1:ncol,1:Nf,1:Na) = 0.0_r8
   aerfwd(1:ncol,1:Nf,1:Na) = 0.0_r8
...
!
   ...
   call CmpDayNite(E_ammr, ammr,	Nday, IdxDay, Nnite, IdxNite, 1, pcols, 1, pver, 1, Na)    ! FAO
...
!   end do
   ...
   do i=1,Nday
      ...
      enddo
      do Za=1,Na
         abund_a(i,k,Za) = ammr(i,k,Za) * path
      enddo
   enddo
   enddo
...
#define FAO_RESCALE_SSA
                  ...
                  ! rescale single scattering albedo -- FAO: DEBUG
                  ssa_scaled = 1.0d0
...
!
   ...
   call ExpDayNite(aertau,	Nday, IdxDay, Nnite, IdxNite, 1, pcols, 1, Nf, 1, Na)
   call ExpDayNite(aerssa,	Nday, IdxDay, Nnite, IdxNite, 1, pcols, 1, Nf, 1, Na)
   call ExpDayNite(aerasm,	Nday, IdxDay, Nnite, IdxNite, 1, pcols, 1, Nf, 1, Na)
   call ExpDayNite(aerfwd,	Nday, IdxDay, Nnite, IdxNite, 1, pcols, 1, Nf, 1, Na)

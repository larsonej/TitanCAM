...
!
   ...
   use shr_const_mod, only: shr_const_g,      shr_const_stebol, shr_const_tkfrz,  &
                            ...
                            shr_const_karman, shr_const_pstd,   shr_const_rhodair, shr_const_avogad
   implicit none
!
...
! Constants for air
   ...
   real(r8), public, parameter :: avogad = shr_const_avogad ! Avogadros number (atoms/mole) 
...
! Molecular weights
   ...
   ! FAO
   real(r8), public, parameter :: mwc2h2 = 26.              ! molecular weight acetylene
   real(r8), public, parameter :: mwc2h4 = 28.              ! molecular weight ethylene
   real(r8), public, parameter :: mwc2h6 = 30.              ! molecular weight ethane
   real(r8), public, parameter :: mwhcn  = 27.              ! molecular weight hydrogen cyanide

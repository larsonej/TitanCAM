...
#PBS -N titancam.nh_m3p5r50-mon-eq-htop
...
setenv runname nh_m3p5r50-mon-eq-htop
...
#    echo "${0}:  copying namelist from $blddir ..." 
    cp $CAM_BASE/lists/namelist_$runname $rundir/namelist_$runname
#  endif

...
c
c
cEJL 4-10-13 looking for value that is not set and causing vf to be NAN
        if (do_print_setup) then
          print *, 'rhoa2(1,2), t(1,1,2), rmu(2), rf(1,j) ', 
     $ rhoa2(1,2), t(1,1,2), rmu(2), rf(1,j)
        endif
c
...
c EJL 4-9-13 changed t2 to t below

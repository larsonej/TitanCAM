...
c
c
c   Define dimensions of local arrays and arrays passed as arguments
c
      parameter( IACAP = 20000, IT = 1 )
c
c
c   Declare arguments passed as arrays
c
      dimension THETD(IT)
c
c
...
c
      ...
      double complex 
     2       FNAP,   FNBP,   ACAP(IACAP),
     2       FNA,    FNB,    RF,       RRF,
     3       RRFX,   WM1,    FN1,      FN2,
     4       TC1,    TC2,    WFN(2),   Z(4),
     5       K1,     K2,     K3,       W(3,IACAP),
     6       RC,     U(8),   DH1,
     7       DH2,    DH4,    P24H24,   P24H21,
     8       PSTORE, HSTORE, DUMMY,    DUMSQ
 
      double precision 
     2       T(5), TA(4), TB(2), TC(2), TD(2), TE(2), 
     3       PI(3,IT), TAU(3,IT), CSTHT(IT), SI2THT(IT),   
     4       ELTRMX(4,IT,2),
     5       X, X1, X4, Y1, Y4, RX, SINX1, SINX4, COSX1, COSX4,
     6       EY1, E2Y1, EY4, EY1MY4, EY1PY4, AA, BB, CC, DD, DENOM,
     7       REALP, AMAGP, QBSR, QBSI, RMM
...
c--alt_imag      imag(z_dum_arg) = dimag(z_dum_arg)
C
C

...
!
      ...
      parameter( NCCBIN = 30) !EJL 1-13-13 for condensation
!
!
!  Define # particle elements 
!
      parameter( NELEM = 4 )   ! Condensation added 
!    EJL 1-31-13, not sure where to set this
!      parameter( NELEM = 1 ) ! HAZE model
!
!
!  Define # particle groups
!
      parameter( NGROUP = 2 ) ! Condenstaiton
!      parameter( NGROUP = 1)  ! HAZE
!
!
!  Define # solutes
!

...
!
!
!  Define tolerance for series convergence in Mie calculations:
!  should be 1.d-7 for 32 bit machines and 1.d-14 for 64 bit machines,
!  regardless of implicit precision defined above
!
...
!
!  Define tolerance for series convergence in Mie calculations:
!  should be 1.d-7 for 32 bit and 1.d-14 for 64 bit machines,
!  regardless of implicit precision defined above
!
      parameter( EPSILON_MIE = 1.d-7 )
!
...
!--inactive--c
!--inactive--c  Define double precision 0.0 
!--inactive--c
!--inactive--      parameter( ZERO = 1.d0 )
!--inactive--c
!--inactive--c
...
!--inactive--c
!--inactive--c
!--inactive--c  Define tolerance for series convergence in Mie calculations:
!--inactive--c  should be 1.d-7 for 32 bit machines and 1.d-14 for 64 bit machines,
!--inactive--c  regardless of implicit precision defined above
!--inactive--c
!--inactive--      parameter( EPSILON_MIE = 1.d-14 )
!--inactive--c
!--inactive--c

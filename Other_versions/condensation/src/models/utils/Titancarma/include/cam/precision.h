...
c  is .true.
c
c     parameter( NCDF_INT = NCDF_LONG )
c     parameter( NCDF_FP  = NCDF_FLOAT )
c
c
c=============================================================================
c
...
c
c  Define tolerance for series convergence in Mie calculations:
c  should be 1.d-7 for 32 bit and 1.d-14 for 64 bit machines,
c  regardless of implicit precision defined above
c

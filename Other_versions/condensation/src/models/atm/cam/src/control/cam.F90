...
! FAO -- debug
subroutine fao_debug_print(str)
  ...
  do i=begchunk, endchunk
     print*, 'FAO_DEBUG(', str, ')', srfflx_parm2d(i)%asdir(1)
  enddo
end subroutine 
...
!-----------------------------NOTICE------------------------------------
!
!            Community Atmospheric Model, $Name:  $ (CAM)
!
! 
...
!
   if (masterproc) then
      ...
      write(6,*)'$Name:  $ '
      write(6,*)'$Date: 2007-08-20 23:18:30 -0600 (Mon, 20 Aug 2007) $'
      write(6,*)'------------------------------------------------------------'

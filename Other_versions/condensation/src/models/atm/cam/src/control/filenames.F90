...
!
!----------------------------------------------------------------------- 
! $Id: filenames.F90 16 2006-12-11 19:09:02Z hpc $
!----------------------------------------------------------------------- 
...
!
   ...
   character(len=256), public :: raddata = 'raddata' ! full pathname for radicals dataset EJL 6-5-10
   ...
   character(shr_kind_cl), public :: carma_optics_file = 'carma_optics_file' ! EJL - carma aerosol optical constants

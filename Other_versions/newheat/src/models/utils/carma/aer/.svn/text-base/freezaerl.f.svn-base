...
c  interval [T0,T]
c
             rhoibar = ( 0.916 * (t3(ixyz)-T0) -
     $         1.75e-4/2. * ((t3(ixyz)-T0)**2) -
     $         5.e-7 * ((t3(ixyz)-T0)**3)/3. ) / (t3(ixyz)-T0)

             rlhbar = ( 79.7 * (t3(ixyz)-T0) +
     $                0.485/2. * (t3(ixyz)-T0)**2 -
     $                2.5e-3/3. * (t3(ixyz)-T0)**3 )
     $                / (t3(ixyz)-T0) * 4.186e7*18.
c
c
...
c
     ...
     $            ( rlhbar * rhoibar * log(T0/t3(ixyz)) +
     $            rhoibar * rgas * 0.5 * (T0+t3(ixyz)) *

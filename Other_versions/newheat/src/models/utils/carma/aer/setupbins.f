...
c  EJL - change df
               ...
               df(j,igrp) = amin1( (3.0 - 1.0*exp(-umon(j,igrp)**(2./3.)
     $                       /5000.0)) ,2.999)
...
c  Print bin structure
     ...
     $              '      df     porosity      umon  hap perm bri eps '
          do i = 1,NBIN
        write(99,'(i3,1pe11.3,1pe11.3,1pe11.3,1pe11.3,1pe11.4,1pe11.3,
     $       1pe11.3,1pe11.3,1pe11.3,1pe11.3)'), i,r(i,j),rf(i,j),
     $       rm(i,j),df(i,j),porosity(i,j), umon(i,j), happel, perm,
     $       brinkman, epsi
          enddo
        write(99,*) ''
      enddo

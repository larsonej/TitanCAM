...
! 
!-----------------------------------------------------------------------
! $Id: history.F90 46 2007-12-14 18:39:12Z hpc $
!-----------------------------------------------------------------------
...
# endif
            ...
            if (masterproc) then
               close (unit=luhrest)
               write(6,*) 'in atm/history', hrestpath(t)
...
!      call add_default ('FSN200C ', 1, ' ')
      ...
      call add_default ('EJLFLXUP', 1, ' ')
      call add_default ('EJLFLXDN', 1, ' ')
!      call add_default ('elup325  ', 1, ' ')
!      call add_default ('elup375  ', 1, ' ')
!      call add_default ('elup425  ', 1, ' ')
!      call add_default ('elup475  ', 1, ' ')
!      call add_default ('elup525  ', 1, ' ')
!      call add_default ('elup575  ', 1, ' ')
!      call add_default ('elup642  ', 1, ' ')
!      call add_default ('elup714  ', 1, ' ')
!      call add_default ('elup784  ', 1, ' ')
!      call add_default ('elup845  ', 1, ' ')
!      call add_default ('elup891  ', 1, ' ')
!      call add_default ('elup940  ', 1, ' ')
!      call add_default ('elup985  ', 1, ' ')
!      call add_default ('elup1070 ', 1, ' ')
!      call add_default ('elup1140 ', 1, ' ')
!      call add_default ('elup1220 ', 1, ' ')
!      call add_default ('elup1290 ', 1, ' ')
!      call add_default ('elup1380 ', 1, ' ')
!      call add_default ('elup1490 ', 1, ' ')
!      call add_default ('elup1610 ', 1, ' ')
!      call add_default ('elup1750 ', 1, ' ')
!      call add_default ('elup1910 ', 1, ' ')
!      call add_default ('elup2110 ', 1, ' ')
!      call add_default ('elup2350 ', 1, ' ')
!      call add_default ('eldn325  ', 1, ' ')
!      call add_default ('eldn375  ', 1, ' ')
!      call add_default ('eldn425  ', 1, ' ')
!      call add_default ('eldn475  ', 1, ' ')
!      call add_default ('eldn525  ', 1, ' ')
!      call add_default ('eldn575  ', 1, ' ')
!      call add_default ('eldn642  ', 1, ' ')
!      call add_default ('eldn714  ', 1, ' ')
!      call add_default ('eldn784  ', 1, ' ')
!      call add_default ('eldn845  ', 1, ' ')
!      call add_default ('eldn891  ', 1, ' ')
!      call add_default ('eldn940  ', 1, ' ')
!      call add_default ('eldn985  ', 1, ' ')
!      call add_default ('eldn1070 ', 1, ' ')
!      call add_default ('eldn1140 ', 1, ' ')
!      call add_default ('eldn1220 ', 1, ' ')
!      call add_default ('eldn1290 ', 1, ' ')
!      call add_default ('eldn1380 ', 1, ' ')
!      call add_default ('eldn1490 ', 1, ' ')
!      call add_default ('eldn1610 ', 1, ' ')
!      call add_default ('eldn1750 ', 1, ' ')
!      call add_default ('eldn1910 ', 1, ' ')
!      call add_default ('eldn2110 ', 1, ' ')
!      call add_default ('eldn2350 ', 1, ' ')

      call add_default ('ALB325  ', 1, ' ')
      call add_default ('ALB375  ', 1, ' ')
      call add_default ('ALB425  ', 1, ' ')
      call add_default ('ALB475  ', 1, ' ')
      call add_default ('ALB525  ', 1, ' ')
      call add_default ('ALB575  ', 1, ' ')
      call add_default ('ALB642  ', 1, ' ')
      call add_default ('ALB714  ', 1, ' ')
      call add_default ('ALB784  ', 1, ' ')
      call add_default ('ALB845  ', 1, ' ')
      call add_default ('ALB891  ', 1, ' ')
      call add_default ('ALB940  ', 1, ' ')
      call add_default ('ALB985  ', 1, ' ')
      call add_default ('ALB1070 ', 1, ' ')
      call add_default ('ALB1140 ', 1, ' ')
      call add_default ('ALB1220 ', 1, ' ')
      call add_default ('ALB1290 ', 1, ' ')
      call add_default ('ALB1380 ', 1, ' ')
      call add_default ('ALB1490 ', 1, ' ')
      call add_default ('ALB1610 ', 1, ' ')
      call add_default ('ALB1750 ', 1, ' ')
      call add_default ('ALB1910 ', 1, ' ')
      call add_default ('ALB2110 ', 1, ' ')
      call add_default ('ALB2350 ', 1, ' ')
...
! Constituent tracers
!
!      write(6,*) 'gotcha' !EJL - this fixes the double counting from carma.f90
...
! This is for when Carma is turned on - removes the double counting in carma.F90
!=============================
      do m=1,3
         call addfld (cnst_name(m), 'kg/kg ',pver,  'A', cnst_longname(m), phys_decomp)
      end do
...
!      call addfld ('EJLALB  ','fraction',1,    'A','Albedo - colums and wavelenghts',phys_decomp)
      call addfld ('EJLFLXUP','W/m2    ',pver,    'A','Upward flux for albedo computation',phys_decomp)
      call addfld ('EJLFLXDN','W/m2    ',pver,    'A','Downward flux for alb compupation',phys_decomp)
!      call addfld ('elup325  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup375  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup425  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup475  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup525  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup575  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup642  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup714  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup784  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup845  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup891  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup940  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup985  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup1070 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup1140 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup1220 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup1290 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup1380 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup1490 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup1610 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup1750 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup1910 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup2110 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('elup2350 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn325  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn375  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn425  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn475  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn525  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn575  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn642  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn714  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn784  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn845  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn891  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn940  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn985  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn1070 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn1140 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn1220 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn1290 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn1380 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn1490 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn1610 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn1750 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn1910 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn2110 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
!      call addfld ('eldn2350 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)

      call addfld ('ALB325  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB375  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB425  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB475  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB525  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB575  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB642  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB714  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB784  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB845  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB891  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB940  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB985  ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB1070 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB1140 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB1220 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB1290 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB1380 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB1490 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB1610 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB1750 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB1910 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB2110 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
      call addfld ('ALB2350 ','fraction',1,    'A','Albedo at the top of the atmosphere',phys_decomp)
...
#ifdef DIUR_AV
      call addfld ('QRS_DA  ','K/s     ',pver, 'I','Diurnal-average solar heating rate',phys_decomp)
      call addfld ('FSNS_DA ','W/m2    ',1,    'I','Diurnal-average net solar flux at surface',phys_decomp)
      call addfld ('FSDS_DA ','W/m2    ',1,    'I','Diurnal-average downwelling solar flux at surface',phys_decomp)
      call addfld ('FSNT_DA ','W/m2    ',1,    'I','Diurnal-average solar flux at TOA',phys_decomp)
      call addfld ('SOLS_DA ','W/m2    ',1,    'I','Diurnal-average direct solar flux onto surface',phys_decomp)
      call addfld ('SOLSD_DA','W/m2    ',1,    'I','Diurnal-average diffuse solar flux onto surface',phys_decomp)
#endif
...
! Dispose history file.  
                  write(6,*) 'in atm/history3',cpath(t)

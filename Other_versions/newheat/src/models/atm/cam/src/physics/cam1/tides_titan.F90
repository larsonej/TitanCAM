...
subroutine tides_titan (ztodt   ,taux    ,tauy    , state   , &
                     tend, ptend)
!EJL 10-20-13 removed flx_bndry flx_bndry)  !ajf 6/26/07 :  tend changed to ptend for output
!----------------------------------------------------------------------- 
! 
! Purpose: 
...
!!!       flx_bndry(i)=0.0
       do k=1,pver
!!!EJL 10-20-13       flx_bndry(i)=flx_bndry(i)+ &

...
c
c
c  Only valid for condensing liquid water currently.
c
        if( gasname(igas) .ne. 'water vapor' )then
          write(LUNOPRT,'(/,a)') 'invalid gas in growevapl.f'
          call endcarma
        endif
c
c

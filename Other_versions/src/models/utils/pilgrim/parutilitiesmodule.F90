...
! !USES:
      ...
      USE shr_kind_mod, only: r8 => shr_kind_r8, i8 => shr_kind_i8, &
                              r4 => shr_kind_r4
#endif
      USE mod_comm, ONLY : commglobal, gid, numpro, blockdescriptor
#include "debug.h"
      IMPLICIT NONE
#include "mpif.h"
#include "pilgrim.h"
...
!      
        ...
        CALL get_partneroffset( PatternOut%SendDesc, PatternOut%RecvDesc )
...
#else
        method = 1     ! Default method - see mod_comm for description
#endif
      ENDIF
!
...
!
      ...
      CALL get_partneroffset( Pattern%SendDesc, Pattern%RecvDesc )

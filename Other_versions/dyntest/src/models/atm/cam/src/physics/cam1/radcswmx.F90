...
!   real(r8) :: ejlalb(pcols,Nf) ! albedo - EJL
   real(r8) :: ejlflxup(pcols,pver) !Fluxes up and used for calculating albedo
   real(r8) :: ejlflxdn(pcols,pver) !
!   real(r8) :: elup325(pcols)
!   real(r8) :: elup375(pcols)
!   real(r8) :: elup425(pcols)
!   real(r8) :: elup475(pcols)
!   real(r8) :: elup525(pcols)
!   real(r8) :: elup575(pcols)
!   real(r8) :: elup642(pcols)
!   real(r8) :: elup714(pcols)
!   real(r8) :: elup784(pcols)
!   real(r8) :: elup845(pcols)
!   real(r8) :: elup891(pcols)
!   real(r8) :: elup940(pcols)
!   real(r8) :: elup985(pcols)
!   real(r8) :: elup1070(pcols)
!   real(r8) :: elup1140(pcols)
!   real(r8) :: elup1220(pcols)
!   real(r8) :: elup1290(pcols)
!   real(r8) :: elup1380(pcols)
!   real(r8) :: elup1490(pcols)
!   real(r8) :: elup1610(pcols)
!   real(r8) :: elup1750(pcols)
!   real(r8) :: elup1910(pcols)
!   real(r8) :: elup2110(pcols)
!   real(r8) :: elup2350(pcols)
!   real(r8) :: eldn325(pcols)
!   real(r8) :: eldn375(pcols)
!   real(r8) :: eldn425(pcols)
!   real(r8) :: eldn475(pcols)
!   real(r8) :: eldn525(pcols)
!   real(r8) :: eldn575(pcols)
!   real(r8) :: eldn642(pcols)
!   real(r8) :: eldn714(pcols)
!   real(r8) :: eldn784(pcols)
!   real(r8) :: eldn845(pcols)
!   real(r8) :: eldn891(pcols)
!   real(r8) :: eldn940(pcols)
!   real(r8) :: eldn985(pcols)
!   real(r8) :: eldn1070(pcols)
!   real(r8) :: eldn1140(pcols)
!   real(r8) :: eldn1220(pcols)
!   real(r8) :: eldn1290(pcols)
!   real(r8) :: eldn1380(pcols)
!   real(r8) :: eldn1490(pcols)
!   real(r8) :: eldn1610(pcols)
!   real(r8) :: eldn1750(pcols)
!   real(r8) :: eldn1910(pcols)
!   real(r8) :: eldn2110(pcols)
!   real(r8) :: eldn2350(pcols)
...
!EJL - calculating the albedo. sum of (fluxup*spectralweight*frcsol) for each wavelength 
 !     divided by the sum of the flux down...
   do i=1,Nday
     do aaa=1,24
     ejlflxup(i,aaa) = solin(i) &
        *(frcsol(4*(aaa-1)+1)*spectralweight(4*(aaa-1)+1,1)*fluxup(4*(aaa-1)+1,0,i) &
     ...
     ejlflxdn(i,aaa) = solin(i)  &
        *(frcsol(4*(aaa-1)+1)*spectralweight(4*(aaa-1)+1,1)*fluxdn(4*(aaa-1)+1,0,i) &
...
!       elup325(i)=ejlflxup(i,1)
!       elup375(i)=ejlflxup(i,2)
!       elup425(i)=ejlflxup(i,3)
!       elup475(i)=ejlflxup(i,4)
!       elup525(i)=ejlflxup(i,5)
!       elup575(i)=ejlflxup(i,6)
!       elup642(i)=ejlflxup(i,7)
!       elup714(i)=ejlflxup(i,8)
!       elup784(i)=ejlflxup(i,9)
!       elup845(i)=ejlflxup(i,10)
!       elup891(i)=ejlflxup(i,11)
!       elup940(i)=ejlflxup(i,12)
!       elup985(i)=ejlflxup(i,13)
!       elup1070(i)=ejlflxup(i,14)
!       elup1140(i)=ejlflxup(i,15)
!       elup1220(i)=ejlflxup(i,16)
!       elup1290(i)=ejlflxup(i,17)
!       elup1380(i)=ejlflxup(i,18)
!       elup1490(i)=ejlflxup(i,19)
!       elup1610(i)=ejlflxup(i,20)
!       elup1750(i)=ejlflxup(i,21)
!       elup1910(i)=ejlflxup(i,22)
!       elup2110(i)=ejlflxup(i,23)
!       elup2350(i)=ejlflxup(i,24)

!       eldn325(i)=ejlflxdn(i,1)
!       eldn375(i)=ejlflxdn(i,2)
!       eldn425(i)=ejlflxdn(i,3)
!       eldn475(i)=ejlflxdn(i,4)
!       eldn525(i)=ejlflxdn(i,5)
!       eldn575(i)=ejlflxdn(i,6)
!       eldn642(i)=ejlflxdn(i,7)
!       eldn714(i)=ejlflxdn(i,8)
!       eldn784(i)=ejlflxdn(i,9)
!       eldn845(i)=ejlflxdn(i,10)
!       eldn891(i)=ejlflxdn(i,11)
!       eldn940(i)=ejlflxdn(i,12)
!       eldn985(i)=ejlflxdn(i,13)
!       eldn1070(i)=ejlflxdn(i,14)
!       eldn1140(i)=ejlflxdn(i,15)
!       eldn1220(i)=ejlflxdn(i,16)
!       eldn1290(i)=ejlflxdn(i,17)
!       eldn1380(i)=ejlflxdn(i,18)
!       eldn1490(i)=ejlflxdn(i,19)
!       eldn1610(i)=ejlflxdn(i,20)
!       eldn1750(i)=ejlflxdn(i,21)
!       eldn1910(i)=ejlflxdn(i,22)
!       eldn2110(i)=ejlflxdn(i,23)
!       eldn2350(i)=ejlflxdn(i,24)
...
!
   ...
   call ExpDayNite(ejlflxup, Nday, IdxDay, Nnite, IdxNite, 1, pcols, 1, pver)
   call ExpDayNite(ejlflxdn, Nday, IdxDay, Nnite, IdxNite, 1, pcols, 1, pver)
!   call ExpDayNite(ejlalb,  Nday, IdxDay, Nnite, IdxNite, 1, pcols, 1, Nf)
!   call ExpDayNite(elup325,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup375,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup425,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup475,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup525,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup575,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup642,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup714,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup784,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup845,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup891,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup940,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup985,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup1070,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup1140,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup1220,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup1290,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup1380,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup1490,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup1610,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup1750,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup1910,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup2110,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(elup2350,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn325,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn375,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn425,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn475,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn525,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn575,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn642,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn714,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn784,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn845,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn891,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn940,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn985,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn1070,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn1140,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn1220,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn1290,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn1380,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn1490,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn1610,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn1750,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn1910,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn2110,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
!   call ExpDayNite(eldn2350,  Nday, IdxDay, Nnite, IdxNite, 1, pcols)
...
!    call outfld('EJLALB  ',ejlalb, pcols,lchnk)
    call outfld('EJLFLXUP',ejlflxup,pcols,lchnk)
    call outfld('EJLFLXDN',ejlflxdn,pcols,lchnk)
!    call outfld('elup325  ',elup325 ,pcols,lchnk)
!    call outfld('elup375  ',elup375 ,pcols,lchnk)
!    call outfld('elup425  ',elup425 ,pcols,lchnk)
!    call outfld('elup475  ',elup475 ,pcols,lchnk)
!    call outfld('elup525  ',elup525 ,pcols,lchnk)
!    call outfld('elup575  ',elup575 ,pcols,lchnk)
!    call outfld('elup642  ',elup642 ,pcols,lchnk)
!    call outfld('elup714  ',elup714 ,pcols,lchnk)
!    call outfld('elup784  ',elup784 ,pcols,lchnk)
!    call outfld('elup845  ',elup845 ,pcols,lchnk)
!    call outfld('elup891  ',elup891 ,pcols,lchnk)
!    call outfld('elup940  ',elup940 ,pcols,lchnk)
!    call outfld('elup985  ',elup985 ,pcols,lchnk)
!    call outfld('elup1070 ',elup1070 ,pcols,lchnk)
!    call outfld('elup1140 ',elup1140 ,pcols,lchnk)
!    call outfld('elup1220 ',elup1220 ,pcols,lchnk)
!    call outfld('elup1290 ',elup1290 ,pcols,lchnk)
!    call outfld('elup1380 ',elup1380 ,pcols,lchnk)
!    call outfld('elup1490 ',elup1490 ,pcols,lchnk)
!    call outfld('elup1610 ',elup1610 ,pcols,lchnk)
!    call outfld('elup1750 ',elup1750 ,pcols,lchnk)
!    call outfld('elup1910 ',elup1910 ,pcols,lchnk)
!    call outfld('elup2110 ',elup2110 ,pcols,lchnk)
!    call outfld('elup2350 ',elup2350 ,pcols,lchnk)
!    call outfld('eldn325  ',eldn325 ,pcols,lchnk)
!    call outfld('eldn375  ',eldn375 ,pcols,lchnk)
!    call outfld('eldn425  ',eldn425 ,pcols,lchnk)
!    call outfld('eldn475  ',eldn475 ,pcols,lchnk)
!    call outfld('eldn525  ',eldn525 ,pcols,lchnk)
!    call outfld('eldn575  ',eldn575 ,pcols,lchnk)
!    call outfld('eldn642  ',eldn642 ,pcols,lchnk)
!    call outfld('eldn714  ',eldn714 ,pcols,lchnk)
!    call outfld('eldn784  ',eldn784 ,pcols,lchnk)
!    call outfld('eldn845  ',eldn845 ,pcols,lchnk)
!    call outfld('eldn891  ',eldn891 ,pcols,lchnk)
!    call outfld('eldn940  ',eldn940 ,pcols,lchnk)
!    call outfld('eldn985  ',eldn985 ,pcols,lchnk)
!    call outfld('eldn1070 ',eldn1070 ,pcols,lchnk)
!    call outfld('eldn1140 ',eldn1140 ,pcols,lchnk)
!    call outfld('eldn1220 ',eldn1220 ,pcols,lchnk)
!    call outfld('eldn1290 ',eldn1290 ,pcols,lchnk)
!    call outfld('eldn1380 ',eldn1380 ,pcols,lchnk)
!    call outfld('eldn1490 ',eldn1490 ,pcols,lchnk)
!    call outfld('eldn1610 ',eldn1610 ,pcols,lchnk)
!    call outfld('eldn1750 ',eldn1750 ,pcols,lchnk)
!    call outfld('eldn1910 ',eldn1910 ,pcols,lchnk)
!    call outfld('eldn2110 ',eldn2110 ,pcols,lchnk)
!    call outfld('eldn2350 ',eldn2350 ,pcols,lchnk)

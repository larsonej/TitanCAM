...
!EJL 9-21-13 commenting out the preprocessor flag for TITAN_FAO in
! an effort to reproduce the correct optical depth with altitude
!
!===================================================
! Moist convection
!===================================================
...
#endif !EJL 9-21-13 commented out TITAN_FAO

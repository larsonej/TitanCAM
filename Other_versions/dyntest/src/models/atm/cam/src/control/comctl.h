...
!-----------------------------------------------------------------------
      ...
      common /comctl/ itsst   ,nsrest  ,iradsw  ,iradlw  ,iradae, ichem
      ...
      common /comctl/ doRamp_scon, fullgrid
      common /comctl/ print_step_cost
      common /comctl/ doabsems, dosw, dolw, dochem, indirect
      ...
      integer ichem             ! Iteration freq. for chemistry
...
! _ord = 4: enhanced PPM (default)
      ...
      logical dochem            ! True => chemistry calculation this timestep

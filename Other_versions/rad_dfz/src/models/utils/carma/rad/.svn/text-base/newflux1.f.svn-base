...
C     LOCAL DIMENSIONS
     ...
     1          Y2(NTOTAL,NGAUSS,NLAYER),
     2          Y4(NTOTAL,NGAUSS,NLAYER),
     3          Y8(NTOTAL,NGAUSS,NLAYER),
     4          A1(NTOTAL,NLAYER),A2(NTOTAL,NLAYER),
     5          A3(NTOTAL,NLAYER),A4(NTOTAL,NLAYER),
     6          A7(NTOTAL,NLAYER),Y5(NTOTAL,NLAYER)
C
      DO 200 J           =  1,NLAYER
          kindex         = max( 1, j-1 )

...
!
      parameter( PREF = 1000.d+3 ) ! Should this be changed? EJL
!
!
...
!
      parameter( RHO_W = 1.d+0 )
!
!
!  Define mass density of water ice [ g / cm^3 ]
!
      parameter( RHO_I = 0.93d+0 )
!
!
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!
...
!    
      ...
      logical do_error, if_sec_mom, if_nuc
      logical do_netcdf, do_parcel
      character*(80) simtitle
      character*(50) elemname, groupname
      character*(20) gasname, solname
      character*(5) caer2s
      character*(6) elemsname
      character*(8) gassname
!
      common /aer2/                                                     &
     ...
     &  do_netcdf, do_parcel, if_nuc(NELEM,NELEM),                      &
     &  ncdf_file,                                                      &
...
!
      common /aer2s/                                                    &
     &  simtitle, elemname(NELEM), groupname(NGROUP),                   &
     &  gasname(NGAS), solname(NSOLUTE),                                &
     &  caer2s, elemsname(NELEM), gassname(NGAS)      
!
!
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!
...
!
     ...
     &  rf(NBIN,NGROUP,NZ), df(NBIN,NGROUP,NZ),                         &
     &  umon(NBIN,NGROUP),                                              &
     &  rm(NBIN,NGROUP,NZ),rmon(NGROUP),                                &
     &  porosity(NBIN,NGROUP,NZ),                                       &
     &  iaer3
!
!
!

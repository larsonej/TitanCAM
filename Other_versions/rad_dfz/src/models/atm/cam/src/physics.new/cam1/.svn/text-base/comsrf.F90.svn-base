...
!
  ...
  use ppgrid, only: pcols, begchunk, endchunk, pvermx, pver !ajf, added pver,9/7/07
...
! --------------------------------------------------------------------------------
! AJF, 9/7/07:  add storage for diurnally averaged sw radiation fields (chunked):
  real(r8), allocatable:: fsds_da(:,:)   ! d.a. surface sw downward
  real(r8), allocatable:: fsns_da(:,:)   ! d.a. surface sw net 
  real(r8), allocatable:: fsnt_da(:,:)   ! d.a. sw net outgoing 
  real(r8), allocatable:: sols_da(:,:)   ! d.a. surface sw direct
  real(r8), allocatable:: solsd_da(:,:)  ! d.a. surface sw diffuse
  real(r8), allocatable:: qrs_da(:,:,:)  ! d.a. sw heating rate 
!---------------------------------------------------------------------------------
...
! AJF, 9/7/07:  allocate diurnally-averaged sw radiation fields (chunked):
    allocate (fsds_da(pcols,begchunk:endchunk))   ! d.a. surface sw downward
    allocate (fsns_da(pcols,begchunk:endchunk))   ! d.a. surface sw net
    allocate (fsnt_da(pcols,begchunk:endchunk))   ! d.a. sw net outgoing
    allocate (sols_da(pcols,begchunk:endchunk))   ! d.a. surface sw direct
    allocate (solsd_da(pcols,begchunk:endchunk))  ! d.a. surface sw diffuse
    allocate (qrs_da(pcols,begchunk:endchunk,pver))  ! d.a. sw heating rate
...
!
    ...
    flnt     (:,:) = inf
! AJF, 9/7/07:
    fsds_da(:,:)=0.0   ! d.a. surface sw downward
    fsns_da(:,:)=0.0   ! d.a. surface sw net
    fsnt_da(:,:)=0.0   ! d.a. sw net outgoing
    sols_da(:,:)=0.0   ! d.a. surface sw direct
    solsd_da(:,:)=0.0  ! d.a. surface sw diffuse
    qrs_da(:,:,:)=0.0

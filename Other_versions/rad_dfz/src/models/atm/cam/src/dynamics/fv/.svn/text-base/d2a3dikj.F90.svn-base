...
! !USES:
      ...
      use pmgrid, only : myid_y, myidxy_y, myidxy_x, nprxy_x, iam
...
! !INPUT PARAMETERS:
      ...
      real(r8), intent(in) :: u(ifirst:ilast,jfirst-ngus:jlast+ngun,ktot) ! U-Wind
...
!$omp  parallel do private(i, k)
         ...
         do k=1,ktot
            do i=ifirst,ilast
               ua(i,k,jlast) = 0.5 * ( u(i,jlast,k) + unorth(i,k) )
            enddo
         enddo
      endif
#endif

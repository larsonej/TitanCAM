...
#if ( defined SPMD )
    call mpibcast(ksul, nrh * nspint, mpir8, 0, mpicom)
    call mpibcast(wsul, nrh * nspint, mpir8, 0, mpicom)
    call mpibcast(gsul, nrh * nspint, mpir8, 0, mpicom)
    call mpibcast(ksslt, nrh * nspint, mpir8, 0, mpicom)
    call mpibcast(wsslt, nrh * nspint, mpir8, 0, mpicom)
    call mpibcast(gsslt, nrh * nspint, mpir8, 0, mpicom)
    call mpibcast(kcphil, nrh * nspint, mpir8, 0, mpicom)
    call mpibcast(wcphil, nrh * nspint, mpir8, 0, mpicom)
    call mpibcast(gcphil, nrh * nspint, mpir8, 0, mpicom)
    call mpibcast(kcphob, nspint, mpir8, 0, mpicom)
    call mpibcast(wcphob, nspint, mpir8, 0, mpicom)
    call mpibcast(gcphob, nspint, mpir8, 0, mpicom)
    call mpibcast(kcb, nspint, mpir8, 0, mpicom)
    call mpibcast(wcb, nspint, mpir8, 0, mpicom)
    call mpibcast(gcb, nspint, mpir8, 0, mpicom)
    call mpibcast(kvolc, nspint, mpir8, 0, mpicom)
    call mpibcast(wvolc, nspint, mpir8, 0, mpicom)
    call mpibcast(gvolc, nspint, mpir8, 0, mpicom)
    call mpibcast(kdst, ndstsz * nspint, mpir8, 0, mpicom)
    call mpibcast(wdst, ndstsz * nspint, mpir8, 0, mpicom)
    call mpibcast(gdst, ndstsz * nspint, mpir8, 0, mpicom)
    call mpibcast(kbg, nspint, mpir8, 0, mpicom)
    call mpibcast(wbg, nspint, mpir8, 0, mpicom)
    call mpibcast(gbg, nspint, mpir8, 0, mpicom)
#endif

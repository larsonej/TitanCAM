...
!-----------------------------------------------------------------------
    ...
    t_grnd         => clm3%g%l%c%ces%t_grnd  ! FAO: modified
    zi             => clm3%g%l%c%cps%zi
    dz             => clm3%g%l%c%cps%dz
    z              => clm3%g%l%c%cps%z
    t_soisno       => clm3%g%l%c%ces%t_soisno ! FAO: modified (?)
    ...
    eflx_gnet      => clm3%g%l%c%p%pef%eflx_gnet  ! FAO: modified
    dgnetdT        => clm3%g%l%c%p%pef%dgnetdT   ! FAO: modified
...
!cdir nodep
       do fc = 1,num_nolakec
          ...
          if (ityplun(l) /= istwet .AND. ityplun(l) /= istice) then
             ...
             !write(*,'(A6,E14.7,E14.7,E14.7,E14.7,E14.7)') 'FAO_N', cv(c,j), csol(c,j), dz(c,j),h2osoi_ice(c,j), h2osoi_liq
          else

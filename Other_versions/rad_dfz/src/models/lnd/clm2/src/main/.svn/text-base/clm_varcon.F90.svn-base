...
! !USES:
  ...
  use shr_const_mod, only: SHR_CONST_G,SHR_CONST_STEBOL,SHR_CONST_KARMAN,     &
                           ...
                           SHR_CONST_ZVIR  !added by ajf, 3/13/06
...
!
! 13 March 06: AJF; Added SHR_CONST_ZVIR and define zvirl below.
!EOP
!-----------------------------------------------------------------------
  ...
  real(r8) :: zvirl  = SHR_CONST_ZVIR     ! 1/eps -1, ajf, 3/13/06

  real(r8), public, parameter :: spval  = 1.e36  ! special value for real data

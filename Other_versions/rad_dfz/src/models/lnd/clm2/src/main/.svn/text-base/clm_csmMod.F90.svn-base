...
! !REVISION HISTORY:
!  02.09.17 Mariana Vertenstein Updated to clm2_1 data structures
!  13 March 06: AJF; added zvirl, definition of epsilon in routine 
!                    and substituted epsi for "0.622", (1-epsi) for ".378"
!
!EOP
!
! !LOCAL VARIABLES:
    ...
    real(r8):: epsi          ! ratio of vapor mw to mw of air, = 1/(1+zvirl)
...
! -----------------------------------------------------------------
    ...
    write(6,*)'(cpl_COMPAT): This is revision: $Revision: 1.2 $'
    write(6,*)'              Tag: $Name:  $'

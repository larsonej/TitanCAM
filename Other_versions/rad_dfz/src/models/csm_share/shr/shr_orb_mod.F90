!===============================================================================
! CVS: $Id: shr_orb_mod.F90 61 2008-03-18 22:05:15Z cam_titan $
! CVS: $Source: /home/cvsroot/cam_titan/src/models/csm_share/shr/shr_orb_mod.F90,v $
! CVS: $Name:  $
!===============================================================================
...
! AJF:  Add L_s = true longitude of planet wrt vernal equinox
   real   (SHR_KIND_R8), public :: L_s
...
!-------------------------------------------------------------------------------
   ...
   mvelp = PLANET_MVELP
   !mvelp = 99.2
   eccen = PLANET_ECCENTRICITY
   obliqr = PLANET_OBLIQUITY
   obliq = PLANET_OBLIQUITY / degrad
#endif
...
!-------------------------------------------------------------------------------
...
#ifdef TITAN_FAO
   real   (SHR_KIND_R8),parameter :: ve     = 1.0    ! Calday of vernal equinox
#else
...
#ifdef TITAN_FAO
   lambm = lambm0 + 2.0*pi * (calday - ve)/(dayspy*PLANET_YEAR_RATIO)
#else
   ...
   !print *, 'FAO_AAA', lamb*180/pi, eccf
